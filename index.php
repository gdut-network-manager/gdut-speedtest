...
<head>
        ...
        <meta charset="UTF-8" />
        <meta name="description" content="Speed Test site.">
        <link rel="icon" href="logo-150x150.png" sizes="32x32" />
        ...
        <script type="text/javascript">
                ...
                var meterBk="#232f4e";
                var dlColorBegin="#04b7fe", dlColorEnd="#70ffb1",
        ...
        <style type="text/css">
                ...
                body{
                        text-align:center;
                        font-family: "MyriadPro","Microsoft YaHei",Helvetica,Arial,sans-serif;
                }
                h1{
                        color:#f4f4f5;
                }
                ...
                .meterText{
                        font-family: "MyriadPro",Futura,gauge-mono,"HCo Gotham SSm",Helvetica,Arial,sans-serif;
                }
        ...
        <div id="testWrapper">
                ...
                <div class="testGroup">
                                <div class="testArea2">
                                        ...
                                        <div id="pingText" class="meterText" style="color:#f4f4f5"></div>
                                        <div class="unit">ms</div>
                                </div>
                                <div class="testArea2">
                                        <div class="testName">抖动</div>
                                        <div id="jitText" class="meterText" style="color:#f4f4f5"></div>
                                        <div class="unit">ms</div>
                                </div>
                        </div>
                        <div class="testGroup">
