...
1、拉取 [Docker 镜像](https://harbor.gdutnic.com/harbor/projects/17/repositories/speedtest-x) `docker pull harbor.gdutnic.com/gdutnic-speedtest/speedtest-x:latest`

2、运行容器 `docker run -d -p 8087:80 --name speedtest-x  --restart always -v /home/speedtest-x:/var/www/html -e TITLE="Your Title" harbor.gdutnic.com/gdutnic-speedtest/speedtest-x:latest`   
...
>
> **-e SAME_IP_MULTI_LOGS=true**: 是否允许同一IP记录多条测速结果
>
> **-e TITLE="GDUTNIC 测速网站"**: 网站名称
